   ...
   <div class="container-fluid marketing">
	  ...
	  <div class="row featurette featurette-odd">
        ...
        <div class="col-md-5">
            ...
            <p class="lead">Choose among several different plataforms to create your game. Your project is compiled in the server and the result is sent back to you. Don't waste more time installing SDKs, they are always updated and ready to use.<br /><br />Available platforms: <br /><img src="./img/platforms.png" title="Available platforms for development." style="margin-top: 10px;"></p>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-4">
            <img class="featurette-image-right" src="./img/browser-chrome.png">
      ...
      <div class="row featurette featurette-odd">
        ...
        <div class="col-md-5">
            ...
            <p class="lead">Choose among several different plataforms to create your game, from Flash/AIR to HTML5/Javascript. Your project is compiled in the server and the result is sent back to you. Don't waste more time installing SDKs, they are always updated and ready to be used. Anywhere, anytime, no matter the device you are using.<br /><br />Some of the platforms available:</p>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-4">
            <img class="featurette-image-right" src="./img/browser-chrome.png">
      ...
      <div class="row featurette featurette-odd">
        <div class="col-md-1"></div>
        <div class="col-md-5">
            <h2 class="featurette-heading">View and edit any file. <span class="text-muted">Text, images, audios, you name it!</span></h2>
            <p class="lead">Choose among several different plataforms to create your game, from Flash/AIR to HTML5/Javascript.</p>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-4">
            <img class="featurette-image-right" src="./img/browser-chrome.png">
